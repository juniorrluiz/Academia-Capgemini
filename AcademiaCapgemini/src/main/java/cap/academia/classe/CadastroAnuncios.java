...
public class CadastroAnuncios {
	...
	public static void main(String[] args) throws ParseException {
		...
		String[] infoAnuncios = new String [5]; // criação do armazenamento em arrays dos dados
		String inf = "";

		CalculadoraAnuncios dadosDoAnuncio[] =  new CalculadoraAnuncios[anuncios];// criação do armazenamento em arrays dos dados
		...
		for (int i = 0; i<anuncios; i++) { // loop do for para armazenamento dos dados em seus respectivos Sets.
			int j = 0;
			while(j<5) {
			...
			dadosDoAnuncio[i] = new CalculadoraAnuncios();  // Armazenamento dos dados em seus respectivos Sets.
		...
		// Processo de criação dos relatórios
